...
This file tracks celebrity Instagram accounts added to the database for demo purposes.
...
1. **@therock** (Dwayne "The Rock" Johnson)
   - Added: 2026-02-23
   - Category: Celebrity
   - Topics: Film and acting, fitness and training, product endorsements
   - Followers: 396M+

2. **@kimkardashian** (Kim Kardashian)
   - Added: 2026-02-23
   - Category: Celebrity
   - Topics: Brand launches, fashion collaborations, family
   - Followers: 363M+

3. **@realdonaldtrump** (Donald Trump)
   - Added: 2026-02-23
   - Category: Celebrity
